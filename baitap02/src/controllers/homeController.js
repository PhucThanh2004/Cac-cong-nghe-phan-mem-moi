...
let deleteCRUD = async (req, res) => {
    let id = req.query.id;  // Lấy id từ query param (?id=1)
    if(id){
        await CRUDService.deleteUserById(id);  // Gọi service để xóa user
...
// Export các hàm ra ngoài để sử dụng ở nơi khác
module.exports = {
